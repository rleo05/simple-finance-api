...
public class TransactionController {
    ...
    public ResponseEntity<DepositWithdrawalResponse> depositMoney(@PathVariable String document, @RequestBody DepositRequest deposit, HttpServletRequest request) {
